...
import bchain_poc.tree.TreeVisitor;
...
import static bchain_poc.processing.path.PathItem.Type.POP;
import static bchain_poc.processing.path.PathItem.Type.PUSH;
import static bchain_poc.tree.Tree.seq;
